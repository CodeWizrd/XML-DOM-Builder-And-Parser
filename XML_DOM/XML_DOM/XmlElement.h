...
namespace XmlProcessing
{
  ...
  public:
	...
	virtual std::vector<std::pair<std::string, std::string>> getAttribs();
	virtual std::vector<std::shared_ptr<AbstractXmlElement>> children();
    virtual std::string value() = 0;
    virtual std::string toString() = 0;
	virtual std::string show() { return " "; }
	virtual std::string type() { return " "; }
	virtual void setText(const std::string& str) {  }
	virtual void resetTab() { count = 0; }
  ...
  inline std::vector<std::pair<std::string, std::string>> AbstractXmlElement::getAttribs() { std::vector<std::pair<std::string, std::string>> attribs; return attribs; }
  inline std::vector<std::shared_ptr<AbstractXmlElement>> AbstractXmlElement::children() { std::vector<std::shared_ptr<AbstractXmlElement>> children; return children; }
  ...
  public:
    ...
    virtual std::string value();
    virtual std::string toString();
	virtual std::string show() { return toString(); }
  private:
    std::string text_;
  };
  ...
  void DFS_r_ltr(std::shared_ptr<AbstractXmlElement> pNode);
